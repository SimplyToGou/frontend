    ...
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 md:mt-20">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="text-sm">
              ...
              <li className="mb-2">
                <a href="/about-us" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Sobre Nosotros</a>
              </li>
              <li className="mb-2">
                <a href="/compare-prices" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Comparar Precios</a>
              </li>
              <li className="mb-2">
                <a href="/history" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Historial</a>
              </li>
              <li className="mb-2">
                <a href="https://providencia.cl/provi/site/edic/base/port/inicio.html" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Municipalidad de Providencia</a>
              </li>
            </ul>
          </div>
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">&copy; SimplyToGou.com. All rights reserved.</div>
