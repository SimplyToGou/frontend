    ...
    <div className="grid relative py-24 justify-center">
      ...
      <div className="flex items-center justify-center max-w-7xl px-6 lg:px-8 py-10 border-b border-gray-900/10 pb-12">
        <div className="mx-auto max-w-2xl lg:mx-0">
          <p className="mt-6 text-md text-blue-700 font-bold" data-aos="zoom-y-out">Aumentando la eficiencia, Simplificando tareas</p>
          <h2 className="text-4xl font-bold tracking-tight text-gray-700 sm:text-5xl" data-aos="zoom-y-out" data-aos-delay="150">Comparación de Productos</h2>
